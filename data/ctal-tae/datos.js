...
const META={
  ...
  planIntro:`<div class="card">
    ...
    <p>Está pensado para <strong>3–5 horas semanales</strong> durante 12 semanas, siguiendo los <strong>8 capítulos oficiales</strong> del syllabus v2.0. Cada semana combina lectura del capítulo, su quiz interactivo y, en las últimas semanas, exámenes completos. Marca cada semana al completarla (el progreso se guarda en este navegador).</p>
  ...
  temarioIntro:`<div class="card">
      ...
      <p>Estructura oficial: 1 Introducción y objetivos · 2 Preparación · 3 Arquitectura (AAPg y MTAP) · 4 Implementación · 5 Estrategias de despliegue (IC/EC) · 6 Suministro de información y métricas · 7 Verificación de la solución · 8 Mejora continua. Cada capítulo incluye un resumen evaluable y un quiz (de 5 a 7 preguntas según el capítulo). Se marca superado al acertar al menos el 80 %.</p>
    </div>`,
...
========================================================= */
const SEMANAS=[
 {cap:1,t:"Capítulo 1 · Introducción y objetivos",d:"Ventajas, desventajas y limitaciones de la automatización. Cómo se aplica en distintos ciclos de vida (cascada, modelo V, ágil). Criterios para seleccionar herramientas según el SSP. Haz el quiz del cap. 1."},
 {cap:2,t:"Capítulo 2 (I) · Preparación: infraestructura y testabilidad",d:"Capacidad de ser probado (control y observabilidad), diseño para la testabilidad, automatización en distintos entornos (web, móvil, IPA/API)."},
 {cap:2,t:"Capítulo 2 (II) · Análisis del SSP y evaluación de herramientas",d:"Analizar el SSP para determinar la SAP adecuada. Proceso de evaluación de herramientas y hallazgos técnicos. Haz el quiz del cap. 2."},
 {cap:3,t:"Capítulo 3 (I) · La arquitectura genérica (AAPg)",d:"Capacidades de la AAPg: generación, definición, ejecución y adaptación. Interfaces con SSP, gestión de proyecto, de configuración y de prueba. Diseño de la SAP/AAP."},
 {cap:3,t:"Capítulo 3 (II) · MTAP por capas, enfoques y patrones",d:"Las 3 capas del MTAP (guiones de prueba, lógica de negocio, librerías base). Enfoques de scripting (captura/repro, lineal, estructurado, data-driven, keyword-driven, DGP/DGC). Patrones (herencia, fachadas, Page Object). Quiz del cap. 3 (el de más peso)."},
 {cap:4,t:"Capítulo 4 · Implementación",d:"Directrices de piloto y despliegue, riesgos del despliegue y su mitigación (cortafuegos, recursos, empaquetado, registro, actualización) y mantenibilidad (código limpio, nomenclatura, evitar codificación rígida). Quiz del cap. 4."},
 {cap:5,t:"Capítulo 5 · Estrategias de despliegue (IC/EC)",d:"Integración de la automatización en canalizaciones por niveles de prueba, gestión de configuración del producto de prueba, dependencias de IPA/API y prueba de contrato. Quiz del cap. 5."},
 {cap:6,t:"Capítulo 6 · Suministro de información y métricas",d:"Recopilación de datos (registros del SSP y del MTAP), niveles de log, análisis de resultados y de fallos, ID de correlación, e informes de avance adaptados a cada audiencia. Quiz del cap. 6."},
 {cap:7,t:"Capítulo 7 · Verificación de la solución",d:"Verificar el entorno (instalación, repetibilidad de montaje/desmontaje, conectividad, prueba de componentes del MTAP), el comportamiento de los guiones, los resultados inesperados y el análisis estático del código. Quiz del cap. 7."},
 {cap:8,t:"Capítulo 8 · Mejora continua",d:"Oportunidades vía datos (histograma de pruebas, IA/autorreparación, validación de esquemas), recomendaciones técnicas de mejora y reestructuración del producto de prueba al cambiar el SSP. Quiz del cap. 8."},
 {sec:"simulacro",t:"Repaso transversal + Simulacro 1",d:"Repite los quizzes donde fallaste. Dibuja de memoria la AAPg y las capas del MTAP. Haz el examen final de la app en condiciones reales (90 min, sin apuntes) y analiza cada fallo."},
 {sec:"simulacro",t:"Simulacro 2 + ajuste final",d:"Haz el ejemplo de examen oficial v2.0 (enlazado en Recursos) cronometrado. Repasa solo puntos débiles y el glosario. Dos días antes: descanso y repaso ligero."}
];
...
{n:1,titulo:"Introducción y objetivos de la automatización",
 ...
 quiz:[
  {k:"k2",q:"¿Cuál de las siguientes es una ventaja característica de la automatización de la prueba?",
  ...
  {k:"k2",q:"¿Cuál es una limitación real de la automatización de la prueba?",
  ...
  {k:"k2",q:"En el modelo V, ¿qué recomendación se hace respecto a la automatización?",
  ...
  {k:"k3",q:"Un equipo con poca experiencia en programación debe automatizar pruebas de una web que cambia poco. ¿Qué opción de herramienta es más razonable como punto de partida?",
  ...
  {k:"k2",q:"¿Cuál de las siguientes es una desventaja (no una limitación) de la automatización de la prueba?",
...
{n:2,titulo:"Preparación para la automatización de la prueba",
 ...
 quiz:[
  {k:"k2",q:"¿Qué describe mejor la controlabilidad de un SSP?",
  ...
  {k:"k3",q:"Una IGU cuyo DOM cambia con frecuencia y carece de identificadores estables rompe los tests en cada entrega. ¿Cuál es la mejor medida a largo plazo?",
  ...
  {k:"k2",q:"Un servicio externo del que depende el SSP solo está disponible unas horas al día y devuelve datos impredecibles. ¿Qué técnica permite automatizar de forma fiable?",
  ...
  {k:"k3",q:"Hay que verificar una regla de cálculo de la capa de negocio que también se muestra en la IGU. ¿Qué nivel de interfaz es, en general, el más adecuado?",
  ...
  {k:"k2",q:"Durante la evaluación de una herramienta, ¿cuál es el propósito principal de una prueba de concepto (piloto de herramienta)?",
  ...
  {k:"k2",q:"¿Qué entorno se utiliza sobre todo para evaluar características de calidad no funcionales (p. ej., eficiencia de desempeño) por ser el más parecido a producción?",
  ...
  {k:"k3",q:"Un equipo quiere validar una nueva versión en producción exponiéndola primero a un pequeño porcentaje de usuarios reales antes de extenderla a todos. ¿Qué técnica de prueba en producción aplica?",
  ...
  {k:"k4",q:"Al analizar un SSP para decidir la SAP, identificas una IGU web, una IPA REST documentada y una dependencia externa con cuotas. ¿Qué combinación de decisiones es la más adecuada?",
...
{n:3,titulo:"Arquitectura de automatización de la prueba (AAPg y MTAP)",
 ...
 quiz:[
  {k:"k2",q:"¿Cuáles son las cuatro capacidades de la arquitectura genérica (AAPg)?",
  ...
  {k:"k2",q:"En el MTAP por capas, ¿qué capa contiene las librerías independientes de cualquier SSP, reutilizables entre proyectos con la misma pila tecnológica?",
  ...
  {k:"k2",q:"Un componente traduce las acciones abstractas de los tests en llamadas concretas a la IPA/API REST del SSP. ¿A qué capacidad de la AAPg pertenece?",
  ...
  {k:"k3",q:"60 guiones repiten copiados los mismos pasos de inicio de sesión con sus localizadores; cada cambio de la pantalla obliga a editar los 60. ¿Qué patrón resuelve el problema?",
  ...
  {k:"k2",q:"¿Cuál es la principal desventaja del enfoque de captura/reproducción?",
  ...
  {k:"k2",q:"¿Qué representa el acrónimo SOLID en el diseño del código de automatización?",
  ...
  {k:"k3",q:"Se quiere garantizar que toda la automatización use un único controlador que se comunique con el SSP. ¿Qué patrón de diseño encaja?",
...
{n:4,titulo:"Implementación de la automatización de la prueba",
 ...
 quiz:[
  {k:"k2",q:"¿Qué característica debe tener el proyecto elegido para pilotar una automatización?",
  ...
  {k:"k3",q:"Un guion de automatización tiene los datos de usuario y las URLs incrustados directamente en el código, y cambian a menudo. ¿Qué práctica de mantenibilidad lo corrige?",
  ...
  {k:"k2",q:"¿Cuál de estos niveles de registro (log) se usa para una condición inesperada que NO rompe el flujo del caso de prueba?",
  ...
  {k:"k3",q:"Un caso manual de 45 pasos cubre alta de cliente, emisión de facturas y baja, con verificaciones intermedias. ¿Cuál es la mejor estrategia al automatizarlo?",
  ...
  {k:"k2",q:"¿Cuál de las siguientes es la MEJOR candidata a automatizarse?",
  ...
  {k:"k4",q:"Tu automatización móvil usa dispositivos reales tras un cortafuegos y arneses que se autoactualizan. ¿Qué análisis de riesgos de despliegue es el correcto?",
...
{n:5,titulo:"Estrategias de implementación y despliegue (IC/EC)",
 ...
 quiz:[
  {k:"k3",q:"Una canalización tarda 3 h porque ejecuta toda la suite E2E en cada commit y el equipo ha dejado de mirar los resultados. ¿Cuál es la mejor reorganización?",
  ...
  {k:"k2",q:"¿Qué verifica la prueba de contrato?",
  ...
  {k:"k2",q:"En el enfoque de prueba de contrato impulsada por el consumidor, ¿quién fija las expectativas?",
  ...
  {k:"k2",q:"¿Qué debe cubrir la gestión de la configuración del producto de prueba en automatización?",
  ...
  {k:"k3",q:"Las pruebas de sistema se integran «como parte de la fase de despliegue». ¿Qué consecuencia tiene este enfoque?",
...
{n:6,titulo:"Suministro de información de la automatización y métricas",
 ...
 quiz:[
  {k:"k2",q:"Una prueba falla, pero el resultado real y el esperado del SSP coinciden. ¿Qué conclusión es la más probable?",
  ...
  {k:"k3",q:"Una suite nocturna informa de un 30 % de fallos; al investigar, todos coinciden con una caída del entorno de prueba a esa hora. ¿Qué indica y qué conviene hacer?",
  ...
  {k:"k2",q:"¿Qué debe contener como mínimo el registro de un caso de prueba fallido para ser útil?",
  ...
  {k:"k2",q:"¿Para qué sirve un ID de correlación (ID de traza) en el análisis de resultados?",
  ...
  {k:"k2",q:"¿Cómo deben adaptarse los informes de avance a sus destinatarios?",
  ...
  {k:"k2",q:"¿Cómo ayudan las herramientas de suministro de información basadas en aprendizaje automático (AA) al analizar los registros de prueba?",
  ...
  {k:"k4",q:"Para analizar los resultados de una ejecución y hallar la causa raíz, ¿qué fuente de datos es primaria y qué implica?",
...
{n:7,titulo:"Verificación de la solución de automatización",
 ...
 quiz:[
  {k:"k2",q:"¿Qué debe verificarse del entorno antes de dar por válidos los resultados de una campaña automatizada?",
  ...
  {k:"k2",q:"Durante una revisión del código de prueba se halla un guion sin ninguna aserción. ¿Qué riesgo señala?",
  ...
  {k:"k3",q:"¿Cuál es la forma más directa de comprobar que un guion nuevo detecta realmente el defecto que dice verificar?",
  ...
  {k:"k3",q:"Un guion da resultados distintos al repetirlo, sin cambios en el SSP. Según la verificación del juego de prueba, ¿qué conviene hacer?",
  ...
  {k:"k2",q:"¿Cómo ayuda el análisis estático a la calidad del código de automatización?",
...
{n:8,titulo:"Mejora continua de la automatización",
 ...
 quiz:[
  {k:"k2",q:"¿Para qué sirve un histograma de pruebas en la mejora continua?",
  ...
  {k:"k2",q:"¿Qué aporta la validación de esquemas al analizar respuestas de una IPA/API?",
  ...
  {k:"k3",q:"Tras cada entrega, el equipo dedica una semana a arreglar tests rotos porque los localizadores están repartidos por cientos de ficheros. ¿Cuál es la mejora prioritaria?",
  ...
  {k:"k4",q:"Las métricas muestran que el mantenimiento de la SAP crece un 15 % por trimestre mientras la suite crece solo un 3 %. ¿Qué conclusión y acción son más razonables?",
  ...
  {k:"k2",q:"¿Qué papel juegan los datos y métricas del capítulo 6 en la mejora continua?",
  ...
  {k:"k3",q:"Una suite falla de forma intermitente por esperas codificadas con tiempos fijos. Entre los mecanismos de espera, ¿cuál es el MÁS fiable cuando el SSP y el lenguaje de guion lo permiten?",
  ...
  {k:"k2",q:"Al refactorizar la SAP, ¿qué ventaja aporta mover a métodos de montaje/desmontaje (setup/teardown) las acciones que se repiten antes o después de cada caso?",
...
const EXAMEN=[
 // ---- Capítulo 1 (4) ----
 {cap:1,k:"k2",q:"¿Cuál de los siguientes NO es un objetivo razonable de la automatización de la prueba?",
 ...
 {cap:1,k:"k2",q:"¿Cuál de las siguientes es una limitación (no una desventaja de coste) de la automatización?",
 ...
 {cap:1,k:"k2",q:"En el desarrollo ágil, ¿qué objetivo persigue «la automatización durante el sprint»?",
 ...
 {cap:1,k:"k3",q:"Un equipo técnico con experiencia en programación va a automatizar un SSP escrito en un lenguaje concreto. ¿Qué criterio de selección de herramienta aporta una ventaja clara?",
 ...
 // ---- Capítulo 2 (6) ----
 {cap:2,k:"k2",q:"El SSP permite consultar su estado interno por un endpoint de diagnóstico y escribe logs estructurados. ¿Qué propiedad de testabilidad ilustran estas facilidades?",
 ...
 {cap:2,k:"k2",q:"¿Cuándo debe diseñarse la capacidad de ser probado (testabilidad) del SSP?",
 ...
 {cap:2,k:"k3",q:"Para preparar precondiciones de pruebas de IGU, un equipo navega por la propia IGU 3 minutos por test. ¿Qué mejora aprovecha mejor la controlabilidad del SSP?",
 ...
 {cap:2,k:"k4",q:"Hay que automatizar un proceso de pago que integra una pasarela externa con sandbox lento y cuotas, con cientos de ejecuciones diarias en CI. ¿Cuál es el mejor diseño?",
 ...
 {cap:2,k:"k2",q:"Al evaluar una herramienta, ¿cuál de estos es un hallazgo técnico relevante?",
 ...
 {cap:2,k:"k2",q:"¿Qué aporta el uso de contenedores e infraestructura como código a la SAP?",
 ...
 // ---- Capítulo 3 (8) ----
 {cap:3,k:"k2",q:"En la AAPg, ¿qué capacidad es responsable del logging y el reporting de las ejecuciones?",
  op:["Generación de pruebas","Definición de pruebas","Ejecución de pruebas","Adaptación de pruebas"],
 ...
 {cap:3,k:"k2",q:"Un componente genera casos de prueba automáticamente a partir de un modelo de estados del SSP. ¿A qué capacidad de la AAPg pertenece?",
  op:["Generación de pruebas","Definición de pruebas","Ejecución de pruebas","Adaptación de pruebas"],
 ...
 {cap:3,k:"k2",q:"¿Con qué áreas define interfaces la AAPg, además de sus capacidades?",
 ...
 {cap:3,k:"k2",q:"En el MTAP por capas, ¿qué regla se aplica a la capa de guiones de prueba?",
 ...
 {cap:3,k:"k2",q:"¿Qué distingue al enfoque keyword-driven del data-driven?",
 ...
 {cap:3,k:"k3",q:"Una SAP mezcla en cada guion la lógica del caso, los localizadores, datos en duro y llamadas directas al driver. ¿Qué refactorización se alinea con la arquitectura?",
 ...
 {cap:3,k:"k2",q:"¿Cuál es una característica del enfoque DGC (BDD) aplicado a la automatización?",
 ...
 {cap:3,k:"k3",q:"Para reducir la duplicación y ocultar la complejidad de las librerías base reutilizables, ¿qué patrones/principios de diseño son adecuados?",
 ...
 // ---- Capítulo 4 (5) ----
 {cap:4,k:"k2",q:"¿Cuál es el propósito principal de un proyecto piloto de automatización?",
 ...
 {cap:4,k:"k2",q:"¿Cuál es la causa más habitual de esfuerzo de mantenimiento del testware?",
 ...
 {cap:4,k:"k3",q:"Un guion de automatización tiene URLs y credenciales incrustadas (hardcoded) que cambian con frecuencia. ¿Qué práctica de mantenibilidad lo corrige?",
 ...
 {cap:4,k:"k2",q:"Una librería de terceros usada por la SAP publica una actualización obligatoria. ¿Qué riesgo de despliegue hay que gestionar?",
 ...
 {cap:4,k:"k3",q:"Un caso manual de 45 pasos (alta, facturación y baja) se va a automatizar. ¿Cuál es la mejor estrategia?",
 ...
 // ---- Capítulo 5 (5) ----
 {cap:5,k:"k3",q:"Una canalización tarda 3 h porque ejecuta toda la suite E2E en cada commit y los desarrolladores ya no miran los resultados. ¿Cuál es la mejor reorganización?",
 ...
 {cap:5,k:"k2",q:"¿Qué verifican las pruebas de contrato?",
 ...
 {cap:5,k:"k2",q:"¿Qué elementos debe cubrir la gestión de configuración del producto de prueba en automatización?",
  op:["Únicamente los guiones de prueba","La configuración del entorno de prueba, los datos de prueba y los juegos/casos de prueba, coherentes con la versión del SSP","Solo los resultados de las ejecuciones","Únicamente las licencias de las herramientas"],
 ...
 {cap:5,k:"k3",q:"Para automatizar pruebas de una IPA/API, ¿qué información sobre dependencias es crucial disponer?",
 ...
 {cap:5,k:"k2",q:"En una canalización que separa construcción y despliegue, ¿qué pruebas forman parte típicamente de la fase de construcción?",
 ...
 // ---- Capítulo 6 (5) ----
 {cap:6,k:"k2",q:"¿Por qué es crítica la fiabilidad de la SAP (proporción de fallos que son falsos positivos o fallos de SAP)?",
 ...
 {cap:6,k:"k3",q:"Una prueba falla pero el resultado real y el esperado del SSP coinciden. ¿Qué estado y acción son correctos?",
 ...
 {cap:6,k:"k2",q:"¿Qué debería contener como mínimo el registro de un caso fallido para ser útil?",
 ...
 {cap:6,k:"k2",q:"Un test de regresión lleva dos años pasando; una revisión descubre que su aserción compara un valor consigo mismo. ¿Qué riesgo ilustra?",
 ...
 {cap:6,k:"k2",q:"¿Cómo deben adaptarse los informes de avance a sus destinatarios?",
 ...
 // ---- Capítulo 7 (4) ----
 {cap:7,k:"k2",q:"Antes de la primera campaña en un entorno recién montado, ¿qué verificación corresponde?",
 ...
 {cap:7,k:"k3",q:"¿Cuál es la forma más directa de comprobar que un guion nuevo detecta realmente el tipo de defecto que dice verificar?",
 ...
 {cap:7,k:"k2",q:"En una revisión del código de prueba, ¿qué hallazgo compromete más la validez de los veredictos?",
 ...
 {cap:7,k:"k3",q:"Un guion falla de forma intermitente sin cambios en el SSP. ¿Cuál es el primer paso adecuado según la verificación de la solución?",
 ...
 // ---- Capítulo 8 (3) ----
 {cap:8,k:"k2",q:"¿Cuál de las siguientes es una oportunidad de mejora continua basada en datos?",
 ...
 {cap:8,k:"k4",q:"El mantenimiento de la SAP crece un 15 % por trimestre mientras la suite crece un 3 %. ¿Qué conclusión y acción son razonables?",
 ...
 {cap:8,k:"k2",q:"¿Qué aporta una herramienta de validación de esquemas como mejora de la SAP?",
...
const EXAMEN2=[
 // ---- Capítulo 1 (4) ----
 {cap:1,k:"k2",q:"¿Cuál de las siguientes pruebas se beneficia especialmente de la automatización por ser inviable a mano?",
 ...
 {cap:1,k:"k2",q:"¿Qué afirmación sobre la automatización en el modelo en cascada es correcta?",
 ...
 {cap:1,k:"k3",q:"Un equipo quiere que perfiles no programadores puedan mantener pruebas de un SSP estable y sencillo. ¿Qué tipo de herramienta encaja mejor como punto de partida?",
 ...
 {cap:1,k:"k2",q:"¿Cuál es una limitación intrínseca (no una desventaja de coste) de la automatización?",
 ...
 // ---- Capítulo 2 (6) ----
 {cap:2,k:"k2",q:"Un SSP ofrece un endpoint para precargar datos y dejar el sistema en un estado concreto antes de cada prueba. ¿Qué propiedad de testabilidad facilita?",
 ...
 {cap:2,k:"k2",q:"¿Por qué conviene automatizar por debajo de la IGU (en IPA/servicio) siempre que sea posible?",
 ...
 {cap:2,k:"k4",q:"Un SSP depende de un servicio de terceros con cuotas estrictas y respuestas variables. Hay que ejecutar cientos de pruebas diarias. ¿Cuál es el mejor diseño de la SAP?",
 ...
 {cap:2,k:"k2",q:"¿Cuándo debe abordarse la capacidad de ser probado (testabilidad) del SSP?",
 ...
 {cap:2,k:"k2",q:"Al evaluar herramientas, ¿qué hallazgo técnico es más relevante para un SSP con IGU compleja?",
 ...
 {cap:2,k:"k4",q:"Un IAP analiza un SSP nuevo para decidir la SAP. ¿Qué información del SSP es prioritaria para esa decisión?",
 ...
 // ---- Capítulo 3 (8) ----
 {cap:3,k:"k2",q:"¿Qué capacidad de la AAPg es responsable de adaptar las pruebas a los distintos componentes e interfaces del SSP?",
 ...
 {cap:3,k:"k2",q:"En el MTAP por capas, una librería que es independiente de cualquier SSP y reutilizable entre proyectos pertenece a:",
 ...
 {cap:3,k:"k2",q:"¿Qué interfaz de la AAPg describe las canalizaciones IC/EC, los entornos y el producto de prueba?",
 ...
 {cap:3,k:"k2",q:"¿Qué enfoque de scripting alimenta los mismos guiones con conjuntos de datos externos (.csv, .xlsx, BD)?",
 ...
 {cap:3,k:"k3",q:"Para que analistas de negocio sin perfil técnico compongan casos combinando acciones como «alta_cliente» o «emitir_factura», ¿qué enfoque encaja mejor?",
 ...
 {cap:3,k:"k2",q:"En el enfoque DGP (TDD) aplicado a la automatización, ¿cuál es la secuencia correcta?",
 ...
 {cap:3,k:"k3",q:"Una capa de guiones de prueba llama directamente a las librerías base, saltándose la lógica de negocio. ¿Por qué es un problema de diseño?",
 ...
 {cap:3,k:"k2",q:"¿Qué patrón de diseño oculta la complejidad de las librerías base ofreciendo una interfaz simplificada, y por qué conviene mantener pocas capas en el MTAP?",
 ...
 // ---- Capítulo 4 (5) ----
 {cap:4,k:"k3",q:"Durante un piloto, ¿qué práctica ayuda a sacar a la luz dificultades de integración de forma temprana?",
 ...
 {cap:4,k:"k2",q:"¿Qué nivel de registro (log) se usa para un evento de error que lleva a abortar la ejecución de la prueba?",
 ...
 {cap:4,k:"k2",q:"¿Cuál de estos es un riesgo técnico de despliegue de la automatización?",
 ...
 {cap:4,k:"k3",q:"Un IAP encuentra métodos de 200 líneas con muchos parámetros y valores incrustados. Según los principios de código limpio, ¿qué debe hacer?",
 ...
 {cap:4,k:"k2",q:"¿Por qué el empaquetado y el control de versiones del producto de prueba son importantes en el despliegue?",
 ...
 // ---- Capítulo 5 (5) ----
 {cap:5,k:"k2",q:"En una canalización que separa construcción y despliegue, ¿qué pruebas actúan como puerta de calidad en la fase de construcción?",
 ...
 {cap:5,k:"k3",q:"Se quiere que un despliegue se revierta automáticamente si fallan las pruebas. ¿Qué enfoque de integración conviene?",
 ...
 {cap:5,k:"k2",q:"¿Qué afirmación sobre la prueba de contrato es correcta?",
 ...
 {cap:5,k:"k2",q:"Para automatizar la prueba de una IPA/API, ¿qué dependencia es crucial conocer?",
 ...
 {cap:5,k:"k2",q:"¿Cómo puede emparejarse de forma exacta la versión del SSP con el producto de prueba que la verifica?",
 ...
 // ---- Capítulo 6 (5) ----
 {cap:6,k:"k2",q:"¿Qué estado de ejecución se aplica cuando el defecto NO está en el SSP sino en la solución de automatización?",
 ...
 {cap:6,k:"k3",q:"Tras una ejecución, TODOS los casos fallan con fallos aparentemente reales. ¿Qué hipótesis conviene investigar primero?",
 ...
 {cap:6,k:"k2",q:"¿Para qué sirve mejorar el software de prueba subyacente (p. ej., registrar hora de inicio/fin)?",
 ...
 {cap:6,k:"k2",q:"¿Qué facilita correlacionar los registros de la SAP con los del SSP para hallar la causa raíz?",
 ...
 {cap:6,k:"k2",q:"Al elaborar un informe de avance, ¿qué prefiere típicamente la audiencia de gestión?",
 ...
 // ---- Capítulo 7 (4) ----
 {cap:7,k:"k2",q:"Antes de utilizar una SAP recién instalada en un nuevo entorno, ¿qué precondición conviene verificar?",
 ...
 {cap:7,k:"k2",q:"Un componente del MTAP que verifica objetos de IGU, ¿cómo debe probarse?",
 ...
 {cap:7,k:"k3",q:"Un guion «pasa» de forma inesperada (debería haber fallado). ¿Qué conviene comprobar primero?",
 ...
 {cap:7,k:"k2",q:"¿Qué aporta el análisis estático en un contexto DevSecOps?",
 ...
 // ---- Capítulo 8 (3) ----
 {cap:8,k:"k3",q:"Una herramienta basada en IA detecta que un localizador de IGU ha cambiado y ajusta el caso para que siga funcionando. ¿Cómo se denomina esta capacidad?",
 ...
 {cap:8,k:"k2",q:"¿Qué ventaja aporta la validación de esquemas al comprobar respuestas de una IPA/API?",
 ...
 {cap:8,k:"k4",q:"Un análisis del histograma de pruebas revela que ciertos casos fallan de forma intermitente sin relación con el SSP. ¿Qué recomendación de mejora es la adecuada?",
...
const EXAMEN3=[
 ...
 {cap:1,k:"k2",q:"¿Cuál de estas actividades NO forma parte de la definición de automatización de la prueba?",
 ...
 {cap:1,k:"k2",q:"En el modelo V, ¿qué es posible y recomendable respecto a los marcos de trabajo (MTAP)?",
 ...
 {cap:1,k:"k3",q:"El SSP es un conjunto de servicios web sin IGU y el equipo es técnico, con experiencia en el mismo lenguaje del SSP. ¿Qué criterio de selección de herramienta aporta más ventaja?",
 ...
 {cap:1,k:"k3",q:"Un equipo quiere retroalimentación rápida de la calidad tras cada construcción y reducir el error humano en pruebas repetitivas. ¿Qué ventajas de la automatización está buscando?",
 ...
 {cap:2,k:"k2",q:"¿Qué distingue a una «variable de despliegue» de una «variable de entorno del sistema» para mejorar la testabilidad?",
 ...
 {cap:2,k:"k3",q:"Para preparar precondiciones de pruebas de IGU, el equipo navega por la propia IGU 3 minutos por test. ¿Qué aprovecha mejor la controlabilidad del SSP?",
 ...
 {cap:2,k:"k3",q:"¿Cuál es el primer entorno en el que conviene monitorizar lo que ocurre en segundo plano durante el uso del SSP para investigar defectos con eficacia?",
 ...
 {cap:2,k:"k4",q:"Analizas un SSP nuevo (web + IPA REST documentada + app móvil) para decidir la SAP. ¿Qué información es prioritaria para la decisión?",
 ...
 {cap:2,k:"k4",q:"El SSP depende de una pasarela externa lenta y con cuotas, y hay que ejecutar cientos de pruebas diarias en CI. ¿Cuál es el mejor diseño de la SAP?",
 ...
 {cap:2,k:"k4",q:"En la tabla comparativa de herramientas, una cubre bien la IGU pero no la IPA, y otra al revés; el SSP necesita ambas. ¿Qué conclusión es razonable?",
 ...
 {cap:3,k:"k2",q:"¿Qué capacidad de la AAPg orquesta las ejecuciones y se encarga del registro en bitácora y el suministro de información?",
  op:["Generación","Definición","Ejecución","Adaptación"],
 ...
 {cap:3,k:"k2",q:"Al diseñar la AAP (diseño técnico de la SAP), ¿cuál de estos aspectos debe abordarse?",
 ...
 {cap:3,k:"k3",q:"Un componente traduce las acciones abstractas de los tests en llamadas concretas a la IPA REST del SSP. ¿A qué capacidad de la AAPg pertenece?",
  op:["Generación","Definición","Ejecución","Adaptación"],
 ...
 {cap:3,k:"k3",q:"Revisando el MTAP, ves que la capa de guiones de prueba llama directamente a las librerías base, saltándose la lógica de negocio. ¿Por qué es un problema?",
  ...
  c:1,e:"Los guiones deben invocar a la lógica de negocio, no a las librerías base directamente; saltarse capas acopla los guiones a detalles de bajo nivel y degrada la mantenibilidad."},
 {cap:3,k:"k3",q:"Hay que ejecutar el mismo flujo de validación con 200 combinaciones de entrada distintas. ¿Qué enfoque de scripting encaja mejor?",
  op:["Captura/reproducción","Guionizado lineal","Prueba guiada por datos (data-driven)","Guionizado sin estructura"],
 ...
 {cap:3,k:"k3",q:"Para garantizar que toda la automatización use una única instancia que se comunica con el SSP, ¿qué patrón aplicas?",
 ...
 {cap:3,k:"k3",q:"En el enfoque DGP (TDD) aplicado a la automatización, ¿cuál es la secuencia correcta?",
 ...
 {cap:4,k:"k2",q:"Entre los niveles de registro, ¿cuál ofrece aún más detalle que «Depuración», útil para investigación profunda?",
 ...
 {cap:4,k:"k3",q:"Durante el piloto, ¿qué práctica saca a la luz dificultades de integración de forma temprana?",
 ...
 {cap:4,k:"k3",q:"Un IAP encuentra métodos de 200 líneas, con muchos parámetros y valores incrustados. Según el código limpio, ¿qué hace?",
 ...
 {cap:4,k:"k4",q:"Pruebas móviles con dispositivos reales tras un cortafuegos, con arneses que se autoactualizan y CI compartiendo recursos. ¿Qué análisis de riesgos de despliegue es correcto?",
 ...
 {cap:4,k:"k4",q:"Una librería de terceros usada por la SAP publica una actualización obligatoria. ¿Cuál es el análisis y la acción adecuados?",
 ...
 {cap:5,k:"k2",q:"En una canalización que separa construcción y despliegue, ¿qué pruebas actúan como puerta de calidad en la fase de construcción?",
  ...
  c:1,e:"Componente e integración de componentes forman parte de la construcción y actúan como puertas de calidad; si tienen éxito, se despliega."},
 {cap:5,k:"k2",q:"En la prueba de contrato impulsada por el proveedor, ¿quién crea el contrato?",
 ...
 {cap:5,k:"k3",q:"Una canalización tarda 3 h porque ejecuta toda la suite E2E en cada commit y el equipo ya no mira los resultados. ¿Cuál es la mejor reorganización?",
  op:["Ejecutar en cada commit solo suites rápidas y estables como puertas de calidad, y mover las E2E largas a etapas posteriores o nocturnas","Eliminar las E2E del todo","Ejecutar la canalización una vez por semana","Pedir commits menos frecuentes"],
 ...
 {cap:5,k:"k3",q:"Quieres una coincidencia exacta entre la versión del SSP y el producto de prueba que la verifica. ¿Cómo lo consigues?",
 ...
 {cap:5,k:"k3",q:"Para construir una estrategia de automatización de IPA, ¿qué dependencias es crucial conocer?",
 ...
 {cap:6,k:"k2",q:"¿Para qué sirve un ID de correlación (ID de traza)?",
 ...
 {cap:6,k:"k3",q:"¿Qué ventaja tiene mejorar el software de prueba subyacente (p. ej., registrar hora de inicio/fin de cada caso)?",
  op:["Solo afecta a un guion concreto","La mejora se aplica a todos los guiones de nivel superior que lo usan","Reduce la fiabilidad de los resultados","Elimina la necesidad de aserciones"],
 ...
 {cap:6,k:"k3",q:"Preparas un informe de avance para dirección y otro para el equipo técnico. ¿Cómo los adaptas?",
 ...
 {cap:6,k:"k4",q:"Una prueba falla, pero el resultado real del SSP coincide con el esperado. ¿Qué estado registras y por qué?",
 ...
 {cap:6,k:"k4",q:"Tras una ejecución, todos los casos fallan a la vez con fallos aparentemente reales. ¿Qué análisis haces?",
 ...
 {cap:7,k:"k2",q:"¿Qué hace el análisis estático y por qué es clave en DevSecOps?",
  ...
  c:1,e:"El análisis estático examina el código sin ejecutarlo, detecta vulnerabilidades/defectos y aplica estándares; en DevSecOps se integra pronto en la canalización para dar feedback inmediato."},
 {cap:7,k:"k3",q:"¿Cuál es la forma más directa de comprobar que un guion nuevo detecta de verdad el defecto que dice verificar?",
 ...
 {cap:7,k:"k3",q:"Un guion da resultados distintos al repetirlo sin cambios en el SSP. ¿Qué procede según la verificación del juego de prueba?",
 ...
 {cap:7,k:"k3",q:"Antes de la primera campaña en un entorno recién montado, ¿qué incluye tu plan de verificación?",
 ...
 {cap:8,k:"k3",q:"El histograma de pruebas revela varios casos que fallan de forma intermitente sin relación con el SSP. ¿Qué mejora aplicas?",
 ...
 {cap:8,k:"k4",q:"Las métricas muestran que el mantenimiento de la SAP crece un 15 % por trimestre mientras la suite crece un 3 %. ¿Qué conclusión y acción son razonables?",
 ...
 {cap:8,k:"k4",q:"El equipo dedica una semana tras cada entrega a arreglar tests rotos porque los localizadores están repartidos por cientos de ficheros. Al analizar la SAP, ¿qué mejora priorizas?",
  op:["Contratar más personas para arreglar tests","Aumentar la abstracción: concentrar los localizadores en la capa de adaptación / Page Object","Reducir la frecuencia de las entregas del SSP","Dejar de ejecutar los tests tras las entregas"],
...
const CASO={
 ...
 capitulos:[
  {n:1,titulo:"Qué automatizar en Aurora y con qué herramienta",
  ...
  {n:2,titulo:"Testabilidad, entornos y evaluación de herramientas",
  ...
  {n:3,titulo:"La AAPg y el MTAP de Aurora",
  ...
  {n:4,titulo:"Piloto, riesgos de despliegue y mantenibilidad",
  ...
  {n:5,titulo:"La canalización IC/EC y el contrato con la pasarela",
  ...
  {n:6,titulo:"Registros, métricas y diagnóstico",
  ...
  {n:7,titulo:"Verificación del entorno de Aurora",
  ...
  {n:8,titulo:"Mejora continua de la SAP de Aurora",
