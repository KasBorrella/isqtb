...
const META={
  ...
  examen:{ preguntas:40, minutos:90, cortePorcentaje:65,
           distribucion:{ 1:4, 2:6, 3:8, 4:5, 5:5, 6:5, 7:4, 8:3 } },
...
{n:1,titulo:"Introducción y objetivos de la automatización",
 ...
 quiz:[
  {id:"q1-1",sec:"1.1",k:"k2",q:"¿Cuál de las siguientes es una ventaja característica de la automatización de la prueba?",
  ...
  {id:"q1-2",sec:"1.1",k:"k2",q:"¿Cuál es una limitación real de la automatización de la prueba?",
  ...
  {id:"q1-3",sec:"1.2",k:"k2",q:"En el modelo V, ¿qué recomendación se hace respecto a la automatización?",
  ...
  {id:"q1-4",sec:"1.2",k:"k3",q:"Un equipo con poca experiencia en programación debe automatizar pruebas de una web que cambia poco. ¿Qué opción de herramienta es más razonable como punto de partida?",
  ...
  {id:"q1-5",sec:"1.1",k:"k2",q:"¿Cuál de las siguientes es una desventaja (no una limitación) de la automatización de la prueba?",
...
{n:2,titulo:"Preparación para la automatización de la prueba",
 ...
 quiz:[
  {id:"q2-1",sec:"2.1",k:"k2",q:"¿Qué describe mejor la controlabilidad de un SSP?",
  ...
  {id:"q2-2",sec:"2.1",k:"k3",q:"Una IGU cuyo DOM cambia con frecuencia y carece de identificadores estables rompe los tests en cada entrega. ¿Cuál es la mejor medida a largo plazo?",
  ...
  {id:"q2-3",sec:"2.1",k:"k2",q:"Un servicio externo del que depende el SSP solo está disponible unas horas al día y devuelve datos impredecibles. ¿Qué técnica permite automatizar de forma fiable?",
  ...
  {id:"q2-4",sec:"2.1",k:"k3",q:"Hay que verificar una regla de cálculo de la capa de negocio que también se muestra en la IGU. ¿Qué nivel de interfaz es, en general, el más adecuado?",
  ...
  {id:"q2-5",sec:"2.2",k:"k2",q:"Durante la evaluación de una herramienta, ¿cuál es el propósito principal de una prueba de concepto (piloto de herramienta)?",
  ...
  {id:"q2-6",sec:"2.1",k:"k2",q:"¿Qué entorno se utiliza sobre todo para evaluar características de calidad no funcionales (p. ej., eficiencia de desempeño) por ser el más parecido a producción?",
  ...
  {id:"q2-7",sec:"2.1",k:"k3",q:"Un equipo quiere validar una nueva versión en producción exponiéndola primero a un pequeño porcentaje de usuarios reales antes de extenderla a todos. ¿Qué técnica de prueba en producción aplica?",
  ...
  {id:"q2-8",sec:"2.2",k:"k4",q:"Al analizar un SSP para decidir la SAP, identificas una IGU web, una IPA REST documentada y una dependencia externa con cuotas. ¿Qué combinación de decisiones es la más adecuada?",
...
{n:3,titulo:"Arquitectura de automatización de la prueba (AAPg y MTAP)",
 ...
 quiz:[
  {id:"q3-1",sec:"3.1.1",k:"k2",q:"¿Cuáles son las cuatro capacidades de la arquitectura genérica (AAPg)?",
  ...
  {id:"q3-2",sec:"3.1.3",k:"k2",q:"En el MTAP por capas, ¿qué capa contiene las librerías independientes de cualquier SSP, reutilizables entre proyectos con la misma pila tecnológica?",
  ...
  {id:"q3-3",sec:"3.1.1",k:"k2",q:"Un componente traduce las acciones abstractas de los tests en llamadas concretas a la IPA/API REST del SSP. ¿A qué capacidad de la AAPg pertenece?",
  ...
  {id:"q3-4",sec:"3.1.5",k:"k3",q:"60 guiones repiten copiados los mismos pasos de inicio de sesión con sus localizadores; cada cambio de la pantalla obliga a editar los 60. ¿Qué patrón resuelve el problema?",
  ...
  {id:"q3-5",sec:"3.1.4",k:"k2",q:"¿Cuál es la principal desventaja del enfoque de captura/reproducción?",
  ...
  {id:"q3-6",sec:"3.1.5",k:"k2",q:"¿Qué representa el acrónimo SOLID en el diseño del código de automatización?",
  ...
  {id:"q3-7",sec:"3.1.5",k:"k3",q:"Se quiere garantizar que toda la automatización use un único controlador que se comunique con el SSP. ¿Qué patrón de diseño encaja?",
...
{n:4,titulo:"Implementación de la automatización de la prueba",
 ...
 quiz:[
  {id:"q4-1",sec:"4.1",k:"k2",q:"¿Qué característica debe tener el proyecto elegido para pilotar una automatización?",
  ...
  {id:"q4-2",sec:"4.3",k:"k3",q:"Un guion de automatización tiene los datos de usuario y las URLs incrustados directamente en el código, y cambian a menudo. ¿Qué práctica de mantenibilidad lo corrige?",
  ...
  {id:"q4-3",sec:"4.2",k:"k2",q:"¿Cuál de estos niveles de registro (log) se usa para una condición inesperada que NO rompe el flujo del caso de prueba?",
  ...
  {id:"q4-4",sec:"4.1",k:"k3",q:"Un caso manual de 45 pasos cubre alta de cliente, emisión de facturas y baja, con verificaciones intermedias. ¿Cuál es la mejor estrategia al automatizarlo?",
  ...
  {id:"q4-5",sec:"4.1",k:"k2",q:"¿Cuál de las siguientes es la MEJOR candidata a automatizarse?",
  ...
  {id:"q4-6",sec:"4.2",k:"k4",q:"Tu automatización móvil usa dispositivos reales tras un cortafuegos y arneses que se autoactualizan. ¿Qué análisis de riesgos de despliegue es el correcto?",
...
{n:5,titulo:"Estrategias de implementación y despliegue (IC/EC)",
 ...
 quiz:[
  {id:"q5-1",sec:"5.1.1",k:"k3",q:"Una canalización tarda 3 h porque ejecuta toda la suite E2E en cada commit y el equipo ha dejado de mirar los resultados. ¿Cuál es la mejor reorganización?",
  ...
  {id:"q5-2",sec:"5.1.3",k:"k2",q:"¿Qué verifica la prueba de contrato?",
  ...
  {id:"q5-3",sec:"5.1.3",k:"k2",q:"En el enfoque de prueba de contrato impulsada por el consumidor, ¿quién fija las expectativas?",
  ...
  {id:"q5-4",sec:"5.1.2",k:"k2",q:"¿Qué debe cubrir la gestión de la configuración del producto de prueba en automatización?",
  ...
  {id:"q5-5",sec:"5.1.1",k:"k3",q:"Las pruebas de sistema se integran «como parte de la fase de despliegue». ¿Qué consecuencia tiene este enfoque?",
...
{n:6,titulo:"Suministro de información de la automatización y métricas",
 ...
 quiz:[
  {id:"q6-1",sec:"6.1.2",k:"k2",q:"Una prueba falla, pero el resultado real y el esperado del SSP coinciden. ¿Qué conclusión es la más probable?",
  ...
  {id:"q6-2",sec:"6.1.2",k:"k3",q:"Una suite nocturna informa de un 30 % de fallos; al investigar, todos coinciden con una caída del entorno de prueba a esa hora. ¿Qué indica y qué conviene hacer?",
  ...
  {id:"q6-3",sec:"6.1.1",k:"k2",q:"¿Qué debe contener como mínimo el registro de un caso de prueba fallido para ser útil?",
  ...
  {id:"q6-4",sec:"6.1.1",k:"k2",q:"¿Para qué sirve un ID de correlación (ID de traza) en el análisis de resultados?",
  ...
  {id:"q6-5",sec:"6.1.3",k:"k2",q:"¿Cómo deben adaptarse los informes de avance a sus destinatarios?",
  ...
  {id:"q6-6",sec:"6.1.3",k:"k2",q:"¿Cómo ayudan las herramientas de suministro de información basadas en aprendizaje automático (AA) al analizar los registros de prueba?",
  ...
  {id:"q6-7",sec:"6.1.2",k:"k4",q:"Para analizar los resultados de una ejecución y hallar la causa raíz, ¿qué fuente de datos es primaria y qué implica?",
...
{n:7,titulo:"Verificación de la solución de automatización",
 ...
 quiz:[
  {id:"q7-1",sec:"7.1.1",k:"k2",q:"¿Qué debe verificarse del entorno antes de dar por válidos los resultados de una campaña automatizada?",
  ...
  {id:"q7-2",sec:"7.1.3",k:"k2",q:"Durante una revisión del código de prueba se halla un guion sin ninguna aserción. ¿Qué riesgo señala?",
  ...
  {id:"q7-3",sec:"7.1.2",k:"k3",q:"¿Cuál es la forma más directa de comprobar que un guion nuevo detecta realmente el defecto que dice verificar?",
  ...
  {id:"q7-4",sec:"7.1.2",k:"k3",q:"Un guion da resultados distintos al repetirlo, sin cambios en el SSP. Según la verificación del juego de prueba, ¿qué conviene hacer?",
  ...
  {id:"q7-5",sec:"7.1.4",k:"k2",q:"¿Cómo ayuda el análisis estático a la calidad del código de automatización?",
...
{n:8,titulo:"Mejora continua de la automatización",
 ...
 quiz:[
  {id:"q8-1",sec:"8.1.1",k:"k2",q:"¿Para qué sirve un histograma de pruebas en la mejora continua?",
  ...
  {id:"q8-2",sec:"8.1.1",k:"k2",q:"¿Qué aporta la validación de esquemas al analizar respuestas de una IPA/API?",
  ...
  {id:"q8-3",sec:"8.1.3",k:"k3",q:"Tras cada entrega, el equipo dedica una semana a arreglar tests rotos porque los localizadores están repartidos por cientos de ficheros. ¿Cuál es la mejora prioritaria?",
  ...
  {id:"q8-4",sec:"8.1.2",k:"k4",q:"Las métricas muestran que el mantenimiento de la SAP crece un 15 % por trimestre mientras la suite crece solo un 3 %. ¿Qué conclusión y acción son más razonables?",
  ...
  {id:"q8-5",sec:"8.1.4",k:"k2",q:"¿Qué papel juegan los datos y métricas del capítulo 6 en la mejora continua?",
  ...
  {id:"q8-6",sec:"8.1.2",k:"k3",q:"Una suite falla de forma intermitente por esperas codificadas con tiempos fijos. Entre los mecanismos de espera, ¿cuál es el MÁS fiable cuando el SSP y el lenguaje de guion lo permiten?",
  ...
  {id:"q8-7",sec:"8.1.2",k:"k2",q:"Al refactorizar la SAP, ¿qué ventaja aporta mover a métodos de montaje/desmontaje (setup/teardown) las acciones que se repiten antes o después de cada caso?",
...
const EXAMEN=[
 // ---- Capítulo 1 (4) ----
 {id:"s1-01",cap:1,sec:"1.1",k:"k2",q:"¿Cuál de los siguientes NO es un objetivo razonable de la automatización de la prueba?",
 ...
 {id:"s1-02",cap:1,sec:"1.1",k:"k2",q:"¿Cuál de las siguientes es una limitación (no una desventaja de coste) de la automatización?",
 ...
 {id:"s1-03",cap:1,sec:"1.2",k:"k2",q:"En el desarrollo ágil, ¿qué objetivo persigue «la automatización durante el sprint»?",
 ...
 {id:"s1-04",cap:1,sec:"1.2",k:"k3",q:"Un equipo técnico con experiencia en programación va a automatizar un SSP escrito en un lenguaje concreto. ¿Qué criterio de selección de herramienta aporta una ventaja clara?",
 ...
 // ---- Capítulo 2 (6) ----
 {id:"s1-05",cap:2,sec:"2.1",k:"k2",q:"El SSP permite consultar su estado interno por un endpoint de diagnóstico y escribe logs estructurados. ¿Qué propiedad de testabilidad ilustran estas facilidades?",
 ...
 {id:"s1-06",cap:2,sec:"2.1",k:"k2",q:"¿Cuándo debe diseñarse la capacidad de ser probado (testabilidad) del SSP?",
 ...
 {id:"s1-07",cap:2,sec:"2.1",k:"k3",q:"Para preparar precondiciones de pruebas de IGU, un equipo navega por la propia IGU 3 minutos por test. ¿Qué mejora aprovecha mejor la controlabilidad del SSP?",
 ...
 {id:"s1-08",cap:2,sec:"2.2",k:"k4",q:"Hay que automatizar un proceso de pago que integra una pasarela externa con sandbox lento y cuotas, con cientos de ejecuciones diarias en CI. ¿Cuál es el mejor diseño?",
 ...
 {id:"s1-09",cap:2,sec:"2.2",k:"k2",q:"Al evaluar una herramienta, ¿cuál de estos es un hallazgo técnico relevante?",
 ...
 {id:"s1-10",cap:2,sec:"2.1",k:"k2",q:"¿Qué aporta el uso de contenedores e infraestructura como código a la SAP?",
 ...
 // ---- Capítulo 3 (8) ----
 {id:"s1-11",cap:3,sec:"3.1.1",k:"k2",q:"En la AAPg, ¿qué capacidad es responsable del logging y el reporting de las ejecuciones?",
  op:["Generación de pruebas","Definición de pruebas","Ejecución de pruebas","Adaptación de pruebas"],
 ...
 {id:"s1-12",cap:3,sec:"3.1.1",k:"k2",q:"Un componente genera casos de prueba automáticamente a partir de un modelo de estados del SSP. ¿A qué capacidad de la AAPg pertenece?",
  op:["Generación de pruebas","Definición de pruebas","Ejecución de pruebas","Adaptación de pruebas"],
 ...
 {id:"s1-13",cap:3,sec:"3.1.1",k:"k2",q:"¿Con qué áreas define interfaces la AAPg, además de sus capacidades?",
 ...
 {id:"s1-14",cap:3,sec:"3.1.3",k:"k2",q:"En el MTAP por capas, ¿qué regla se aplica a la capa de guiones de prueba?",
 ...
 {id:"s1-15",cap:3,sec:"3.1.4",k:"k2",q:"¿Qué distingue al enfoque keyword-driven del data-driven?",
 ...
 {id:"s1-16",cap:3,sec:"3.1.3",k:"k3",q:"Una SAP mezcla en cada guion la lógica del caso, los localizadores, datos en duro y llamadas directas al driver. ¿Qué refactorización se alinea con la arquitectura?",
 ...
 {id:"s1-17",cap:3,sec:"3.1.4",k:"k2",q:"¿Cuál es una característica del enfoque DGC (BDD) aplicado a la automatización?",
 ...
 {id:"s1-18",cap:3,sec:"3.1.5",k:"k3",q:"Para reducir la duplicación y ocultar la complejidad de las librerías base reutilizables, ¿qué patrones/principios de diseño son adecuados?",
 ...
 // ---- Capítulo 4 (5) ----
 {id:"s1-19",cap:4,sec:"4.1",k:"k2",q:"¿Cuál es el propósito principal de un proyecto piloto de automatización?",
 ...
 {id:"s1-20",cap:4,sec:"4.3",k:"k2",q:"¿Cuál es la causa más habitual de esfuerzo de mantenimiento del testware?",
 ...
 {id:"s1-21",cap:4,sec:"4.3",k:"k3",q:"Un guion de automatización tiene URLs y credenciales incrustadas (hardcoded) que cambian con frecuencia. ¿Qué práctica de mantenibilidad lo corrige?",
 ...
 {id:"s1-22",cap:4,sec:"4.2",k:"k2",q:"Una librería de terceros usada por la SAP publica una actualización obligatoria. ¿Qué riesgo de despliegue hay que gestionar?",
 ...
 {id:"s1-23",cap:4,sec:"4.1",k:"k3",q:"Un caso manual de 45 pasos (alta, facturación y baja) se va a automatizar. ¿Cuál es la mejor estrategia?",
 ...
 // ---- Capítulo 5 (5) ----
 {id:"s1-24",cap:5,sec:"5.1.1",k:"k3",q:"Una canalización tarda 3 h porque ejecuta toda la suite E2E en cada commit y los desarrolladores ya no miran los resultados. ¿Cuál es la mejor reorganización?",
 ...
 {id:"s1-25",cap:5,sec:"5.1.3",k:"k2",q:"¿Qué verifican las pruebas de contrato?",
 ...
 {id:"s1-26",cap:5,sec:"5.1.2",k:"k2",q:"¿Qué elementos debe cubrir la gestión de configuración del producto de prueba en automatización?",
  op:["Únicamente los guiones de prueba","La configuración del entorno de prueba, los datos de prueba y los juegos/casos de prueba, coherentes con la versión del SSP","Solo los resultados de las ejecuciones","Únicamente las licencias de las herramientas"],
 ...
 {id:"s1-27",cap:5,sec:"5.1.3",k:"k3",q:"Para automatizar pruebas de una IPA/API, ¿qué información sobre dependencias es crucial disponer?",
 ...
 {id:"s1-28",cap:5,sec:"5.1.1",k:"k2",q:"En una canalización que separa construcción y despliegue, ¿qué pruebas forman parte típicamente de la fase de construcción?",
 ...
 // ---- Capítulo 6 (5) ----
 {id:"s1-29",cap:6,sec:"6.1.2",k:"k2",q:"¿Por qué es crítica la fiabilidad de la SAP (proporción de fallos que son falsos positivos o fallos de SAP)?",
 ...
 {id:"s1-30",cap:6,sec:"6.1.2",k:"k3",q:"Una prueba falla pero el resultado real y el esperado del SSP coinciden. ¿Qué estado y acción son correctos?",
 ...
 {id:"s1-31",cap:6,sec:"6.1.1",k:"k2",q:"¿Qué debería contener como mínimo el registro de un caso fallido para ser útil?",
 ...
 {id:"s1-32",cap:6,sec:"6.1.1",k:"k2",q:"Un test de regresión lleva dos años pasando; una revisión descubre que su aserción compara un valor consigo mismo. ¿Qué riesgo ilustra?",
 ...
 {id:"s1-33",cap:6,sec:"6.1.3",k:"k2",q:"¿Cómo deben adaptarse los informes de avance a sus destinatarios?",
 ...
 // ---- Capítulo 7 (4) ----
 {id:"s1-34",cap:7,sec:"7.1.1",k:"k2",q:"Antes de la primera campaña en un entorno recién montado, ¿qué verificación corresponde?",
 ...
 {id:"s1-35",cap:7,sec:"7.1.2",k:"k3",q:"¿Cuál es la forma más directa de comprobar que un guion nuevo detecta realmente el tipo de defecto que dice verificar?",
 ...
 {id:"s1-36",cap:7,sec:"7.1.3",k:"k2",q:"En una revisión del código de prueba, ¿qué hallazgo compromete más la validez de los veredictos?",
 ...
 {id:"s1-37",cap:7,sec:"7.1.3",k:"k3",q:"Un guion falla de forma intermitente sin cambios en el SSP. ¿Cuál es el primer paso adecuado según la verificación de la solución?",
 ...
 // ---- Capítulo 8 (3) ----
 {id:"s1-38",cap:8,sec:"8.1.1",k:"k2",q:"¿Cuál de las siguientes es una oportunidad de mejora continua basada en datos?",
 ...
 {id:"s1-39",cap:8,sec:"8.1.2",k:"k4",q:"El mantenimiento de la SAP crece un 15 % por trimestre mientras la suite crece un 3 %. ¿Qué conclusión y acción son razonables?",
 ...
 {id:"s1-40",cap:8,sec:"8.1.1",k:"k2",q:"¿Qué aporta una herramienta de validación de esquemas como mejora de la SAP?",
...
const EXAMEN2=[
 // ---- Capítulo 1 (4) ----
 {id:"s2-01",cap:1,sec:"1.1",k:"k2",q:"¿Cuál de las siguientes pruebas se beneficia especialmente de la automatización por ser inviable a mano?",
 ...
 {id:"s2-02",cap:1,sec:"1.2",k:"k2",q:"¿Qué afirmación sobre la automatización en el modelo en cascada es correcta?",
 ...
 {id:"s2-03",cap:1,sec:"1.2",k:"k3",q:"Un equipo quiere que perfiles no programadores puedan mantener pruebas de un SSP estable y sencillo. ¿Qué tipo de herramienta encaja mejor como punto de partida?",
 ...
 {id:"s2-04",cap:1,sec:"1.1",k:"k2",q:"¿Cuál es una limitación intrínseca (no una desventaja de coste) de la automatización?",
 ...
 // ---- Capítulo 2 (6) ----
 {id:"s2-05",cap:2,sec:"2.1",k:"k2",q:"Un SSP ofrece un endpoint para precargar datos y dejar el sistema en un estado concreto antes de cada prueba. ¿Qué propiedad de testabilidad facilita?",
 ...
 {id:"s2-06",cap:2,sec:"2.1",k:"k2",q:"¿Por qué conviene automatizar por debajo de la IGU (en IPA/servicio) siempre que sea posible?",
 ...
 {id:"s2-07",cap:2,sec:"2.2",k:"k4",q:"Un SSP depende de un servicio de terceros con cuotas estrictas y respuestas variables. Hay que ejecutar cientos de pruebas diarias. ¿Cuál es el mejor diseño de la SAP?",
 ...
 {id:"s2-08",cap:2,sec:"2.1",k:"k2",q:"¿Cuándo debe abordarse la capacidad de ser probado (testabilidad) del SSP?",
 ...
 {id:"s2-09",cap:2,sec:"2.2",k:"k2",q:"Al evaluar herramientas, ¿qué hallazgo técnico es más relevante para un SSP con IGU compleja?",
 ...
 {id:"s2-10",cap:2,sec:"2.2",k:"k4",q:"Un IAP analiza un SSP nuevo para decidir la SAP. ¿Qué información del SSP es prioritaria para esa decisión?",
 ...
 // ---- Capítulo 3 (8) ----
 {id:"s2-11",cap:3,sec:"3.1.1",k:"k2",q:"¿Qué capacidad de la AAPg es responsable de adaptar las pruebas a los distintos componentes e interfaces del SSP?",
 ...
 {id:"s2-12",cap:3,sec:"3.1.3",k:"k2",q:"En el MTAP por capas, una librería que es independiente de cualquier SSP y reutilizable entre proyectos pertenece a:",
 ...
 {id:"s2-13",cap:3,sec:"3.1.1",k:"k2",q:"¿Qué interfaz de la AAPg describe las canalizaciones IC/EC, los entornos y el producto de prueba?",
 ...
 {id:"s2-14",cap:3,sec:"3.1.4",k:"k2",q:"¿Qué enfoque de scripting alimenta los mismos guiones con conjuntos de datos externos (.csv, .xlsx, BD)?",
 ...
 {id:"s2-15",cap:3,sec:"3.1.4",k:"k3",q:"Para que analistas de negocio sin perfil técnico compongan casos combinando acciones como «alta_cliente» o «emitir_factura», ¿qué enfoque encaja mejor?",
 ...
 {id:"s2-16",cap:3,sec:"3.1.4",k:"k2",q:"En el enfoque DGP (TDD) aplicado a la automatización, ¿cuál es la secuencia correcta?",
 ...
 {id:"s2-17",cap:3,sec:"3.1.3",k:"k3",q:"Una capa de guiones de prueba llama directamente a las librerías base, saltándose la lógica de negocio. ¿Por qué es un problema de diseño?",
 ...
 {id:"s2-18",cap:3,sec:"3.1.5",k:"k2",q:"¿Qué patrón de diseño oculta la complejidad de las librerías base ofreciendo una interfaz simplificada, y por qué conviene mantener pocas capas en el MTAP?",
